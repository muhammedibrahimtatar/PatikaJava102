...
public class ProductManager
{
    ...
    public ProductManager(String name,Brand brandOfPruduct, double screenSize,double battaryPower,int memory,int ram,  String color,  int price, int quality,int discountRate) {
        this.name = name;
